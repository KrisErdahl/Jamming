...
const Spotify = {
	getAccessToken() {
		...
		if (accessTokenMatch && expiresInMatch) {
			...
			const accessUrl = `https://accounts.spotify.com/authorize?client_id=${clientID}&response_type=token&scope=playlist-modify-private&playlist-modify-public&user-read-private&user-library-read&user-modify-library&user-read-email&redirect_uri=${redirectURI}`;
